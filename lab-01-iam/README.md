...
![Users and Groups overview](screenshots/01-users-groups-overview.png)
![Inline policy on EC2-Admin](screenshots/02-inline-policy-ec2admin.png)
...
![Adding user to group](screenshots/03-add-user-to-group.png)
![All groups showing 1 member each](screenshots/04-group-membership-confirmed.png)
...
![user-1 S3 access](screenshots/05-user1-s3-access.png)
![user-1 EC2 denied](screenshots/06-user1-ec2-denied.png)
![user-2 EC2 read-only, stop denied](screenshots/07-user2-ec2-readonly-stop-denied.png)
![user-3 EC2 stop success](screenshots/08-user3-ec2-stop-success.png)
